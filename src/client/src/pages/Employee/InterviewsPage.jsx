...
const InterviewsPage = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{
            ...
            <CardContent>
              <Typography variant="h5" gutterBottom sx={{ fontWeight: 600, color: '#6B5544', mb: 2, fontSize: '1.5rem' }}>
                Upcoming Interviews
              </Typography>
              <List>
      ...
      >
        <DialogTitle sx={{ fontWeight: 700, color: '#6B5544', fontSize: '1.75rem' }}>Interview Details</DialogTitle>
        <DialogContent>
          {selectedInterview && (
            <Box>
